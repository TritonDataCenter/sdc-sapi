 ...
 * Create a instance.
 */
Model.prototype.createInstance = function (inst, wait, cb) {
	var self = this;
	var log = self.log;
	...
	async.waterfall([
		...
		function (subcb) {
			deployInstance.call(self, inst, wait, subcb);
		}
	], function (err) {
		if (err) {
			/*
...
function deployInstance(inst, wait, cb) {
	var self = this;
	...
	async.waterfall([
		...
		function (params, _, subcb) {
			provisionZone.call(self, params, wait, subcb);
		}
...
function provisionZone(params, wait, cb) {
	var self = this;
	var log = self.log;
